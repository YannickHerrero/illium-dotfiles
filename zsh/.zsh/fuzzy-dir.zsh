# f()  — Fuzzy cd into top-level ~/dev folders (fzf + eza preview)
# fd() — Deep fuzzy cd into ~/dev subfolders (excludes node_modules, .git, etc.)
# ff() — Fuzzy file finder — opens selected file in nvim (bat preview)
